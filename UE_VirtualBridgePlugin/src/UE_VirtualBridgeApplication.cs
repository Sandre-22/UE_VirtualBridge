namespace Loupedeck.UE_VirtualBridgePlugin
{
    ...
    public class UE_VirtualBridgeApplication : ClientApplication
    {
        public UE_VirtualBridgeApplication()
        {
        }

        // This method can be used to link the plugin to a Windows application.
        protected override String GetProcessName() => "Epic Games Launcher";
