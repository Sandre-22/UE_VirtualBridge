namespace Loupedeck.UE_VirtualBridgePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.UE_VirtualBridgePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.UE_VirtualBridgePlugin.Resources.Resource.txt`.
